    ...
    <main className="min-h-screen bg-[#060913] text-white">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-white/40">
                    Practical lessons & real-world training
                  </p>

                </div>

                <span className="text-white/30 group-hover:text-yellow-400 transition">
                  →
                </span>
      ...
      <footer className="border-t border-white/10 px-6 py-10">
        ...
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-4 text-sm text-white/40 md:flex-row">
          ...
          <p>
            © 2026 Learn • Prove • Earn. All rights reserved.
          </p>
