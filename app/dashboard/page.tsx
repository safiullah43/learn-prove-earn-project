  ...
  useEffect(() => {
    async function checkUser() {
      ...
      const { data: enrollmentData, error } = await supabase
        .from("enrollments")
        .select("id, course_id, status, progress, enrolled_at")
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
          ...
          {enrollmentLoading ? (
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              {enrollments.map((enrollment) => {
                const courseName =
                  courseNames[enrollment.course_id] ||
                  `Course ${enrollment.course_id}`;

                const description =
                  courseDescriptions[enrollment.course_id] ||
                  "Continue your learning journey.";

                const icon =
                  courseIcons[enrollment.course_id] || "📚";
                ...
                return (
                  ...
                  >
                    ...
                    <Link
                      ...
                      className="mt-6 block rounded-xl bg-yellow-400 px-5 py-3 text-center text-sm font-black text-black transition hover:bg-yellow-300"
                    >
                      Continue Learning →
                    </Link>
        ...
        <div className="mt-10 rounded-3xl border border-yellow-400/10 bg-yellow-400/[0.04] p-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-white/45">
            Learn practical skills, prove what you know,
            build your portfolio, and turn your skills into
            real opportunities.
          </p>
